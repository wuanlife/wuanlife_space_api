...
class Domain_Group {
    ...
    public function create($data) {
            ...
            $path=$RootDIR."/../../public/upload/group/$date/";
            ...
            if ($this->u_status == '1' && $this->g_status =='1') {
                ...
                if(empty($data["g_image"])) {
                    ...
                    $data["g_image"] = $filepath;
                }
                if(empty($data['g_introduction'])) {
                    $data['g_introduction']=NULL;
                }
                $data = array('name' => $data['name'],'g_image'=>"..".substr($data["g_image"],53),'g_introduction' => $data['g_introduction']) ;
    ...
    public function posts($data){
        ...
        $date=date("Y/m/d");
        $RootDIR = dirname(__FILE__);
        $path=$RootDIR."/../../public/upload/posts/$date/";
