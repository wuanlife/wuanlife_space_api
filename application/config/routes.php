...
$route['articles/(:num)/reapproval']['put'] = 'articles/reapproval/$1';
$route['articles/(:num)/lock']['post'] = 'articles/lock/$1';
$route['articles/(:num)/clear']['put'] = 'articles/clear/$1';
$route['articles/(:num)']['delete'] = 'articles/articles/$1';
$route['users/(:num)/collections']['put'] = 'articles/collections/$1';
$route['users/(:num)/recollections']['put'] = 'articles/recollections/$1';